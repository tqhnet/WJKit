...
#import "IMERefreshController.h"
#import "IMEHeader.h"

@interface IMERefreshController ()

@end

@implementation IMERefreshController
...
- (void)viewDidLayoutSubviews {
    self.tableView.frame = CGRectMake(0, self.navView.height, SCREEN_WIDTH, self.view.height - self.navView.height );
}
